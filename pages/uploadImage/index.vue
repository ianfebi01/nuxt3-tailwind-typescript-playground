...
<template>
  <Transition>
    <div class="relative w-full h-full flex items-center justify-center">
      <!-- content -->
      <div
        class="relative flex flex-col gap-2 w-full max-w-[706px] h-full max-h-[604px] bg-white rounded-lg py-6 px-5"
      >
        ...
        <button
          class="h-[44px] text-blue-500 border border-blue-500 disabled:bg-gray-200 disabled:border-none disabled:text-gray-400"
          disabled
          @click="handleSubmit"
        >
          Upload
